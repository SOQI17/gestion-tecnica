...
// Remove the first engineer selection on load if it causes issues
content = content.replace(
...
// Replace Ingeniero references in types to Engineer
content = content.replace(
